...
const st = (day: number, owners: number[] = []): ChainState => ({
  ...
  author: "0xAAAA000000000000000000000000000000000001", renderer: "0x3333333333333333333333333333333333333333", rendererLocked: false, secondsLeft: 100, claims: new Map(), readAt: Date.now(),
